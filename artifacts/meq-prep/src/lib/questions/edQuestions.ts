...
The ED registrar says: "He's calmed down, his obs are stable, and I need the bed. My consultant says this is a drug psychosis — once he's settled he can go." When you interview Marcus, he says the transmitters have been monitoring him "for six months." His sister, contacted by phone, says she has been worried about him for eight months: he stopped going to work, began spending hours researching "surveillance technology," and only started using methamphetamine last week "to cope with the fear."`,
    ...
    signals: [
      ...
      {
        id: "s7",
        name: "Methamphetamine use still requires assessment and harm-reduction planning",
        category: "substance_use",
        severity: "important",
        clueInStem: "A urine drug screen is positive for methamphetamine.",
        whyItMatters: "Missing this signal means the candidate has rejected the drug-only diagnosis without still assessing methamphetamine use as an acute risk amplifier and relapse factor.",
        modelWording: "Assess methamphetamine use directly, because it may have escalated Marcus's psychosis, impaired sleep and judgement, and must be addressed in the follow-up plan.",
        keywords: ["methamphetamine", "urine drug screen", "substance use", "sleep", "harm reduction", "drug use", "acute risk", "relapse"],
      },
    ],
    priorityOrder: {
      urgent: ["s1", "s2", "s3"],
...
My risk assessment would address self-neglect, vulnerability in public, risk of acting on persecutory beliefs, substance use, family supports, insight and willingness to accept follow-up. The positive methamphetamine screen still matters: it may have amplified his fear, impaired sleep and judgement, and needs direct assessment and harm-reduction planning even though it is not the primary explanation. His sister's collateral is central to the formulation and should inform both the diagnosis and the safety plan.
...
The ED consultant says he is willing to "accept her decision" because she is "calm, oriented, and not suicidal." Eliza says she does not want her parents, who are in the waiting room, to be involved. The treating ED team has commenced IV electrolyte replacement, which she is tolerating.`,
    ...
    signals: [
      ...
      {
        id: "s7",
        name: "Partial acceptance of treatment should be used to build engagement",
        category: "disposition",
        severity: "important",
        clueInStem: "The treating ED team has commenced IV electrolyte replacement, which she is tolerating.",
        whyItMatters: "Missing this signal means the candidate has ignored an opportunity to build therapeutic engagement while also mistaking partial electrolyte treatment for adequate management.",
        modelWording: "Recognise her acceptance of IV electrolyte replacement as an engagement opportunity, while explaining that it does not replace nutrition, admission or refeeding management.",
        keywords: ["IV electrolyte", "tolerating", "engagement", "partial treatment", "alliance", "refeeding", "admission", "nutrition"],
      },
      {
        id: "s8",
        name: "Hypoglycaemia requires immediate treatment before psychiatric assessment",
        category: "physical_health",
        severity: "critical",
        clueInStem: "glucose 3.1 mmol/L",
        whyItMatters: "Missing this signal means the candidate has not recognised hypoglycaemia as an immediate medical emergency requiring treatment before any psychiatric assessment.",
        modelWording: "Treat hypoglycaemia immediately because glucose 3.1 mmol/L in a severely malnourished patient requires urgent correction before psychiatric assessment can meaningfully proceed.",
        keywords: ["glucose", "hypoglycaemia", "3.1", "blood sugar", "immediate treatment"],
      },
      {
        id: "s9",
        name: "Ten-year illness history indicates chronicity and treatment resistance",
        category: "diagnosis_formulation",
        severity: "important",
        clueInStem: "a ten-year history of anorexia nervosa",
        whyItMatters: "Missing this signal means the candidate has not used chronicity to assess prior hospitalisations, treatment resistance and prognosis.",
        modelWording: "Review the ten-year illness history to assess prior hospitalisations, treatment responses, lowest previous BMI and trajectory because chronicity changes both prognosis and the urgency threshold for intervention.",
        keywords: ["ten year", "history", "chronicity", "previous admission", "treatment resistance", "trajectory"],
      },
      {
        id: "s10",
        name: "Refeeding syndrome requires specific monitoring protocol",
        category: "physical_health",
        severity: "important",
        clueInStem: "The treating ED team has commenced IV electrolyte replacement, which she is tolerating.",
        whyItMatters: "Missing this signal means the candidate has accepted IV electrolyte replacement without addressing refeeding syndrome monitoring and prevention.",
        modelWording: "Establish refeeding syndrome monitoring protocol because electrolyte replacement in severe anorexia nervosa requires cardiac monitoring, thiamine, controlled reintroduction of nutrition and phosphate surveillance.",
        keywords: ["refeeding syndrome", "electrolyte", "thiamine", "phosphate", "cardiac monitoring", "protocol"],
      },
      {
        id: "s11",
        name: "Starvation produces cognitive distortion distinct from capacity impairment",
        category: "diagnosis_formulation",
        severity: "important",
        clueInStem: "I understand exactly what you're telling me. I know the risks and I choose to go home.",
        whyItMatters: "Missing this signal means the candidate has not recognised that chronic starvation produces cognitive rigidity and distorted values distinct from the formal capacity assessment.",
        modelWording: "Recognise that chronic starvation produces cognitive distortion and rigid illness-driven values that are distinct from the formal capacity assessment and must be named explicitly in the clinical formulation.",
        keywords: ["starvation", "cognitive distortion", "rigid", "illness values", "chronic malnutrition", "formulation"],
      },
    ],
    priorityOrder: {
      urgent: ["s1", "s2", "s3"],
      secondary: ["s4", "s5", "s6", "s7", "s8", "s9", "s10", "s11"],
      lowYield: [],
    },
...
The ED registrar tells you: "She's been here twice before for confusion — both times they said it was her dementia and she went home. Her daughter says she's been going downhill anyway."`,
    ...
    signals: [
      ...
      {
        id: "s7",
        name: "Distress should be managed as part of delirium care",
        category: "disposition",
        severity: "important",
        clueInStem: "She is distressed and repeatedly calls for her late husband.",
        whyItMatters: "Missing this signal means the candidate may respond to Nora's distress with unnecessary sedation rather than orientation, reassurance and family-supported delirium care.",
        modelWording: "Address Nora's distress with non-pharmacological delirium care, because calling for her late husband reflects fear and disorientation rather than a primary psychotic disorder.",
        keywords: ["distressed", "late husband", "orientation", "reassurance", "non-pharmacological", "family", "delirium care", "avoid sedation"],
      },
    ],
    priorityOrder: {
      urgent: ["s1", "s2", "s3"],
...
Nora should not be discharged tonight. She is confused, refusing food and medications, and lives semi-independently in a granny flat. I would recommend admission for delirium work-up, including infection screen, electrolytes, renal and liver function, medication review and hydration assessment. Her distress and repeated calling for her late husband should be managed with orientation, reassurance, family presence, sleep-wake support and avoidance of unnecessary sedation.`,
  },
...
The ED consultant comes on the phone and says: "We need him sedated now before you assess him — he's not safe in the department." Jake's mother pulls you aside and says he had a "very bad experience six months ago — they held him down and injected him — he's been terrified of hospitals since." She says he has been "really well" on his depot until two days ago, when something happened at his supported accommodation that upset him. His last risperidone LAI was 22 days ago and is prescribed three-weekly.`,
    ...
    modelAnswer: `Jake is agitated and psychotic, but the stem is explicit that he is not currently assaulting anyone. I would not authorise sedation by phone before assessment. I would attend immediately, and my first action on arrival is to attempt structured verbal de-escalation — approach calmly with as few staff as possible, reduce environmental noise, keep security at a respectful distance, address him by name, and acknowledge that he is frightened. Pharmacological restraint before a genuine attempt at verbal de-escalation is not justifiable on these facts.

Jake's prior restraint trauma is the most important engagement factor in this stem. His mother says that six months ago he was held down and injected and has been terrified of hospitals since. Repeating forced restraint without first attempting alternatives risks re-traumatisation and permanently damages his willingness to engage with services. Every step of my approach must be explicitly trauma-informed — explain what I am doing before I do it, seek his agreement at each point, and avoid any action that mimics the previous restraint experience without clinical necessity.

The accommodation precipitant must be clarified. He was well on his depot until two days ago when something happened at his supported accommodation. That event may be a traumatic incident, conflict, abuse, substance use or another acute stressor — and it changes both the formulation and the management plan. I cannot assume this is simple relapse without understanding what happened.

His depot timing is clinically relevant. His risperidone LAI was given 22 days ago on a three-weekly schedule, meaning he is at the end of his dosing interval. Declining plasma levels combined with an acute psychosocial stressor may be producing breakthrough symptoms. Once he is settled I would offer his depot with his agreement as part of the management plan.

His mother's safety requires direct assessment. She has experienced two days of threatening comments at home and brought him to ED. I would ask her directly what was said, whether she felt physically at risk, and whether she can safely return home with him if he is discharged. Her account is both essential collateral and a risk formulation factor.

If de-escalation fails and Jake cannot engage voluntarily, I would move to a formal Mental Health Act assessment rather than informal coercion. The criteria are met — he has a mental illness, there is risk from psychosis and threatening behaviour, treatment is needed, and voluntary options have been exhausted. I would document the de-escalation attempts, the legal criteria, and explain the process to Jake directly even if he cannot fully engage with the explanation.

Capacity is impaired. Jake understands the nature of his illness and retains information adequately. However he cannot use and weigh treatment options free from psychotic distortion — his refusal is driven by the illness, not autonomous values. I would document this across all four domains explicitly.

Post-sedation if required — vital signs, ECG for QTc monitoring, one-to-one observation, and a clear transfer plan. ED is non-therapeutic and re-traumatising for Jake. Admission to an inpatient psychiatric unit is the appropriate disposition. I would explain the decision to his mother, validate her distress, involve her in the treatment plan going forward, and ensure she understands that once Jake regains insight we will explain the reasoning to him directly to preserve the therapeutic relationship.`,
  },
...
When you speak to Jade alone, she tells you she has been cutting for approximately four months and has been hiding it. She shows you multiple healed scars. She says she "doesn't feel safe at home" but cannot say more. She becomes tearful when her mother's name is mentioned.`,
    ...
    signals: [
      ...
      {
        id: "s7",
        name: "Developmental formulation is required for emerging psychopathology",
        category: "diagnosis_formulation",
        severity: "important",
        clueInStem: "The paediatric ED asks you to review Jade, a 15-year-old girl who presented with superficial lacerations to her forearms.",
        whyItMatters: "Missing this signal means the candidate has treated the presentation as an isolated ED event rather than formulating emerging psychopathology in an adolescent developmental context.",
        modelWording: "Formulate developmentally by considering emerging emotional dysregulation, depressive episode, attachment difficulties and trauma response in the context of adolescence and family conflict.",
        keywords: ["developmental formulation", "adolescent", "emerging psychopathology", "emotional dysregulation", "depressive", "attachment", "trauma response", "family conflict"],
      },
      {
        id: "s8",
        name: "Functional assessment across school, peers and family is needed",
        category: "diagnosis_formulation",
        severity: "important",
        clueInStem: "When you speak to Jade alone, she tells you she has been cutting for approximately four months and has been hiding it.",
        whyItMatters: "Missing this signal means the candidate has not assessed the sustained functional impact of four months of hidden self-harm across school, social and family domains.",
        modelWording: "Assess school attendance, academic change, peer relationships, online stressors and family functioning because four months of hidden cutting implies sustained distress beyond tonight's argument.",
        keywords: ["school", "peers", "social", "family functioning", "functional assessment", "academic", "attendance", "online", "four months"],
      },
      {
        id: "s9",
        name: "Substance use screen is part of adolescent self-harm assessment",
        category: "substance_use",
        severity: "important",
        clueInStem: "She self-inflicted the cuts with scissors three hours ago.",
        whyItMatters: "Missing this signal means the candidate has omitted a standard risk amplifier in adolescent self-harm assessment, including intoxication, disinhibition and coping-related substance use.",
        modelWording: "Screen for alcohol, cannabis, vaping and other substance use because intoxication and disinhibition can change risk, supervision needs and discharge safety.",
        keywords: ["substance use", "alcohol", "cannabis", "vaping", "intoxication", "disinhibition", "adolescent", "self-harm", "screen"],
      },
    ],
    priorityOrder: {
      urgent: ["s1", "s2", "s3"],
      secondary: ["s4", "s5", "s6", "s7", "s8", "s9"],
      lowYield: [],
    },
...
I would formulate this developmentally rather than as an isolated ED event. Jade is 15, her parents are separated, there is high conflict in the corridor, she becomes tearful when her mother's name is mentioned, and she has hidden self-harm for months. The differential includes emerging emotional dysregulation, depressive episode, attachment difficulties and trauma response, and the assessment must include school attendance, academic change, peer relationships, online stressors, substance use and family functioning.
...
Discharge tonight is only appropriate if I can clarify the home safety concern, complete a credible safety plan with Jade and a safe adult, restrict access to means, and arrange urgent CAMHS follow-up within 48–72 hours. If home safety remains unclear, if Jade cannot speak safely, if substance use or functional deterioration increases concern, or if child protection planning cannot be completed, admission under CAMHS or paediatrics for further assessment and safeguarding is the safer disposition.`,
  },
];
