...
A review of the hospital records shows two previous ED presentations in the last twelve months — one for a laceration to the forearm and one for intoxication.`,
    ...
    modelAnswer: `Daniel's presentation is a high-lethality, high-knowledge suicide attempt and must be treated as such from the moment I arrive. He is a trained paramedic who ingested approximately 60 oxycodone tablets — he knows what that dose does, he knows about naloxone reversal, and he knows how to search for lethal doses. His phone search for opioid lethal dose while in ED is not background information. It is evidence of active ongoing suicidal intent occurring right now, in this department, and requires immediate intervention including confiscation of the phone and one-to-one observation.

The flatmate's collateral is the most important clinical information in this stem. Daniel has not eaten, has not left his room, and has been giving away his guitar for two weeks. Giving away a valued possession is preparatory behaviour consistent with a planned suicide attempt — this was not impulsive. He was sacked from his job as a paramedic last month following an internal complaint. Occupational loss combined with professional shame in a highly trained first responder is a high-risk precipitant. Paramedics have elevated suicide rates, detailed lethality knowledge, and significant barriers to help-seeking related to professional identity and stigma.

His hostility and demand to go home after surviving a near-fatal overdose must be formulated clinically, not just managed behaviourally. Regret at survival following a high-lethality attempt is itself a high-risk feature and must be directly and sensitively explored once he is sufficiently alert. His refusal to discuss what happened is understandable but cannot determine the clinical decision. I would not attempt a full psychiatric assessment while he is drowsy from naloxone — medical stability comes first, formal MSE follows once he is alert, and he cannot leave in the interim.

The two previous ED presentations in twelve months — forearm laceration and intoxication — establish a longitudinal pattern of self-harm and risky substance use. This is not a first presentation. The forearm laceration requires exploration once he is alert — was it self-inflicted, what was the context, was it ever assessed psychiatrically.

Discharge is not safe under any circumstances tonight. The risk factors are compounding — high-lethality method, professional lethality knowledge, preparatory behaviour, active phone search for lethal dose, possible regret at survival, occupational loss, social withdrawal, previous self-harm, and hostility toward assessment. I would initiate one-to-one nursing, remove access to means including medications and sharps, prevent absconding, and document the clinical basis for detention clearly.

Regarding capacity and MHA — Daniel is currently drowsy from naloxone. A valid capacity assessment requires the patient to be sufficiently alert to engage with all four domains. I cannot complete a formal capacity assessment now and would not attempt one. Similarly a full MHA assessment cannot be completed while he is not alert enough to engage.

However most Australian MHAs allow a clinician to initiate a detention order for the purpose of psychiatric assessment based on reasonable grounds — without requiring the full assessment to be completed first. Daniel gives me reasonable grounds right now — high-lethality overdose, preparatory behaviour, active phone search for lethal dose, previous self-harm, and active attempt to leave before assessment is complete. I would initiate a detention order for assessment on those grounds, document the reasoning clearly, and explain the process to Daniel directly even if he cannot fully engage.

Once Daniel is alert I would complete a formal capacity assessment across all four domains. On current clinical information capacity is likely to be impaired — he may understand the information superficially but his ability to use and weigh treatment versus leaving is likely distorted by underlying depression and active suicidal intent, meaning the illness is driving the demand to leave rather than autonomous values. I would document this formally once he can engage.

Full MHA criteria — mental illness, risk to self, need for treatment, no less restrictive option — will be assessed formally once he is alert and a complete MSE can be conducted. His MSE should cover depression, psychosis, adjustment disorder and substance use disorder. Opioid withdrawal planning and monitoring should begin in parallel with psychiatric assessment. If full MHA criteria are confirmed at that point I would initiate an involuntary treatment order and document each criterion explicitly.`,
  },
    ...
    signals: [
      {
        ...
        category: "immediate_safety",
        severity: "critical",
        clueInStem: "Priya has not slept in three days, is increasingly agitated, and told a midwife this morning: \"My baby is not real. Someone has replaced him with a different baby.\"",
        whyItMatters: "Missing this signal means the candidate has failed to recognise postpartum psychosis as an acute psychiatric emergency requiring immediate containment and treatment.",
        modelWording: "Recognise postpartum psychosis urgently because day-four onset, no sleep, agitation and delusional misidentification of the baby indicate high-risk acute illness.",
      ...
      },
      {
        ...
        whyItMatters: "Missing this signal means the candidate has failed to identify Priya's direct concern about harming the infant as an immediate infant-safety risk.",
        relatedRisk: "Infanticide; harm to infant",
        modelWording: "Identify infant safety risk because Priya's statement that she does not trust her hands requires supervised contact and immediate protection planning.",
      ...
      },
      {
        ...
        category: "risk_self",
        severity: "critical",
        clueInStem: "Priya has not slept in three days, is increasingly agitated",
        whyItMatters: "Missing this signal means the candidate has focused only on infant risk and failed to assess maternal suicide and self-harm risk in postpartum psychosis.",
        modelWording: "Assess maternal suicide risk because severe insomnia, agitation and psychosis in the early postpartum period create acute risk to Priya as well as the baby.",
      ...
      },
      {
        ...
        whyItMatters: "Missing this signal means the candidate has failed to recognise delusional misidentification of the infant as a specific high-risk psychotic feature.",
        modelWording: "Formulate the belief that the baby has been replaced as a Capgras-type delusion because it increases risk and must not be minimised as anxiety.",
      ...
      },
      {
        ...
        severity: "critical",
        clueInStem: "Priya declines to hold him",
        whyItMatters: "Missing this signal means the candidate has failed to translate the psychotic presentation and impaired infant contact into an urgent admission decision.",
        relatedSystem: "Mother-baby unit; if unavailable, adult inpatient with controlled infant access",
        modelWording: "Clarify urgent inpatient admission because Priya's psychosis and refusal to hold the infant require safe containment, ideally in a mother-baby unit.",
      ...
      },
      {
        ...
        whyItMatters: "Missing this signal means the candidate has failed to identify family minimisation that could delay treatment and make discharge unsafe.",
        modelWording: "Address Rajan's minimisation because he needs urgent psychoeducation that this is postpartum psychosis, not normal postnatal tiredness.",
      ...
      },
      {
        ...
        whyItMatters: "Missing this signal means the candidate has failed to use family collateral that may support a diagnosis of postpartum psychosis and genetic vulnerability.",
        modelWording: "Recognise the mother-in-law's account as diagnostically relevant because a similar family episode may indicate vulnerability to postpartum psychosis.",
      ...
      },
      {
        ...
        category: "cultural_safety",
        severity: "important",
        clueInStem: "In our family in India",
        whyItMatters: "Missing this signal means the candidate has failed to consider how South Asian family context, stigma and gendered expectations may shape engagement.",
        modelWording: "Address cultural and family context respectfully because stigma, maternal-role expectations and family hierarchy may affect treatment acceptance.",
      ...
      },
      {
        ...
        category: "physical_health",
        severity: "important",
        clueInStem: "Priya has not slept in three days",
        whyItMatters: "Missing this signal means the candidate has failed to recognise sleep deprivation as both a trigger and maintaining factor in postpartum psychosis.",
        modelWording: "Identify sleep restoration as an immediate treatment priority because three days without sleep can worsen postpartum psychosis.",
      ...
      },
      {
        ...
        category: "diagnosis_formulation",
        severity: "important",
        clueInStem: "whether the baby monitor is recording everything she says",
        whyItMatters: "Missing this signal means the candidate has failed to identify paranoid ideation that confirms broader psychotic illness and may impair engagement.",
        modelWording: "Formulate the baby-monitor concern as paranoid ideation because it confirms psychosis beyond the infant misidentification belief.",
      ...
      },
      {
        ...
        severity: "important",
        clueInStem: "Priya declines to hold him, saying \"What if I hurt him by accident — I don't trust my hands.\"",
        whyItMatters: "Missing this signal means the candidate has failed to consider child protection duties despite explicit infant-safety concerns during acute psychosis.",
        relatedLegal: "Child Protection Act (jurisdiction-specific); mandatory reporting obligations",
        modelWording: "Notify or consult child protection as required because Priya's psychosis and stated fear of harming the baby meet a low reporting threshold.",
      ...
      },
      {
        ...
        whyItMatters: "Missing this signal means the candidate has failed to consider breastfeeding and infant medication exposure when planning postnatal pharmacotherapy.",
        modelWording: "Address breastfeeding compatibility when selecting medication because postnatal antipsychotic treatment requires explicit infant-exposure consideration.",
    ...
    signals: [
      {
        ...
        whyItMatters: "Missing this signal means the candidate has failed to recognise reasonable suspicion that a current child may be at risk from the alleged perpetrator.",
        ...
        modelWording: "Notify child protection immediately because a twelve-year-old repeatedly attending the home of an alleged child sexual abuser meets the reporting threshold.",
      ...
      },
      {
        ...
        category: "ethics",
        severity: "critical",
        clueInStem: "Please don't tell anyone. I'll lose my family. I promise I will stop seeing you if you tell anyone.",
        whyItMatters: "Missing this signal means the candidate has either promised confidentiality that cannot be kept or failed to explain mandatory reporting limits transparently.",
        modelWording: "Clarify the limits of confidentiality before reporting because honesty about mandatory obligations is essential to preserving the therapeutic frame.",
      ...
      },
      {
        ...
        category: "risk_self",
        severity: "critical",
        clueInStem: "has been contacting her again over the past six months, \"pushing her to meet.\"",
        whyItMatters: "Missing this signal means the candidate has failed to address Jade's own ongoing safety risk from renewed perpetrator contact.",
        modelWording: "Assess Jade's immediate safety because renewed pressure from the alleged perpetrator requires a plan separate from the child protection report.",
      ...
      },
      {
        ...
        category: "trauma",
        severity: "important",
        clueInStem: "I promise I will stop seeing you if you tell anyone.",
        whyItMatters: "Missing this signal means the candidate has failed to recognise the threat to end therapy as a trauma-linked rupture requiring careful containment.",
        modelWording: "Address the threatened rupture compassionately because mandatory action must be taken while maintaining transparency and offering ongoing therapy.",
      ...
      },
      {
        ...
        category: "immediate_safety",
        severity: "important",
        clueInStem: "Jade becomes very distressed",
        whyItMatters: "Missing this signal means the candidate has allowed a highly distressed trauma patient to leave without an immediate safety plan after disclosure.",
        modelWording: "Assess immediate post-session safety because Jade needs a concrete plan, support contacts and a confirmed follow-up before leaving.",
