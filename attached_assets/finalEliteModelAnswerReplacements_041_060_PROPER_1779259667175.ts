// Proper, non-template consultant-prose modelAnswer replacements for FINAL-041 to FINAL-060.
// Replace ONLY modelAnswer fields in finalEliteMEQBank.ts by matching id.

export const FINAL_ELITE_MODEL_ANSWER_REPLACEMENTS_041_060 = [
  {
    id: "FINAL-041",
    modelAnswer: `Maria's chemotherapy refusal should not be overridden simply because delay may reduce cure, but it also should not be accepted as a settled autonomous refusal without assessing depressive guilt. The unsafe shortcut is the oncologist's question, "Delay will reduce cure; can we override her?" The urgency is real because curative lymphoma treatment is time-sensitive, but urgency does not make psychiatry a permission slip for forced chemotherapy. A consultant response has to protect Maria's autonomy while recognising that a severe depressive syndrome can distort the very capacity required to refuse treatment.

The key phrase is Maria's statement, "I deserve this cancer; treatment is wasted on me." That is not a neutral weighing of chemotherapy burden against benefit. It suggests pathological guilt, worthlessness and possibly psychotic depressive thinking, directly linked to her refusal. I would assess whether she understands the diagnosis, the chance of cure, the risks of delay, the burdens of chemotherapy and the alternatives, but the central issue is whether she can appreciate that treatment is being offered because she has worth and a realistic chance of benefit, rather than because she deserves punishment.

The legal and ethical tension is captured by the registrar's question, "Does depression automatically remove capacity?" It does not. Depression can coexist with capacity, and a patient can refuse curative treatment for values-based reasons. But here the refusal appears to arise from depressive self-condemnation, and her husband reports, "Last month she was begging to start treatment," suggesting a recent and illness-linked reversal. I would clarify the timeline, prior values, current suicidal ideation, psychosis, appetite, sleep, cognitive impairment and whether urgent antidepressant, antipsychotic or ECT-level treatment is needed to restore decision-making.

Her husband and family are vulnerable in different ways. The husband is excluded by her statement, "Do not involve my husband; he should find someone better," which sounds more like depressive guilt than a stable relational boundary. I would explore confidentiality carefully, seek her consent to involve him, and if she refuses, consider whether limited family collateral is justified for capacity assessment while minimising disclosure. Her mother's preference for traditional healer remedies should be approached respectfully, not dismissed, but it must not amplify depressive incapacity or delay potentially curative treatment without Maria's valid consent.

I would document the oncology urgency, the exact guilt-laden refusal, the husband's collateral that her wishes changed, the capacity findings, the cultural discussion about traditional healing, and the treatment plan for depression. If refusal is capacitous, the record must show why. If it is not capacitous, the record must show the lawful pathway, why delay was unsafe, and why any temporary override was proportionate to preserve a chance of cure while treating the mental disorder impairing the decision.`,
  },
  {
    id: "FINAL-042",
    modelAnswer: `Mr Singh's wish to stop treatment should not be overridden simply because his family says, "Our faith says you must continue everything." That is the unsafe shortcut: allowing family distress or religious pressure to replace the patient's own capacity and values. At the same time, his statement cannot be accepted uncritically because he is intermittently awake after multi-organ failure and gives inconsistent wishes. The consultant task is to determine whether "No more tubes; let me go" is a capacitous, stable refusal or a fluctuating ICU statement affected by delirium, sepsis, sedation, pain or fear.

The phrase "No more tubes; let me go" is clinically important because it may express a genuine wish to limit burdensome treatment. It is not automatically suicidal or depressive. However, the fact that he later gives different wishes and that family have been interpreting because staff think he understands "enough English" means the assessment so far is not valid. I would require a professional Punjabi interpreter, assess at the best time of day when he is most awake, and ask what he understands about dialysis, ventilation, likely outcomes, and what level of recovery he would consider acceptable.

The legal tension is the ICU consultant's question, "Can he refuse dialysis today?" If he has decision-specific capacity at the relevant time, he can refuse dialysis even if refusal may hasten death. If he lacks capacity, decisions should follow substitute decision or best-interests law, incorporating prior expressed wishes such as the daughter's collateral, "He said he never wanted machines." The wife and son may see stopping treatment as killing him, but the law and ethics distinguish allowing refusal of burdensome treatment from causing death.

The vulnerable parties here are not only Mr Singh but also the divided family, who may be left with guilt and conflict. I would hold a structured goals-of-care meeting with ICU, interpreter, family and spiritual care if wanted. I would acknowledge the wife's faith-based distress and the son's statement, "Stopping treatment is killing him," while explaining that treatment decisions must be guided by Mr Singh's valid wishes and lawful process, not by family unanimity. Cultural and religious values should inform communication and support, not substitute for capacity assessment.
